...
export function HistoryPanel({ limit = 6 }: { limit?: number }) {
  ...
  return (
    <section aria-label="Dernières modifications" className="rounded-xl border border-line bg-paper px-3 pt-3 pb-2">
      <header className="mb-1 flex items-center">
        <h2 className="font-display text-[17px] font-semibold tracking-tight text-ink">Dernières modifications</h2>
